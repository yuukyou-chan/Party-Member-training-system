<template>
  <div class="InforBase-container">
    ...
    <el-card class="filter-card">
      <div slot="header" class="clearfix">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>申请表</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <!-- 数据筛选表单 -->
      <el-form ref="form"  label-width="70px" size="small">
        ...
        <el-form-item label="学号查询">
          ...
          <el-button type="primary" :disabled="loading" @click="getApplicationSheets()" style="margin-left: 10px;"
            >查询</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    <el-card class="box-card">
      ...
      <el-pagination
      background
      @size-change="getApplicationSheets"
      @current-change="getApplicationSheets"
...
import {
  getApplicationSheets, // 获取申请书列表
  getMajors, // 获取专业列表
  deleteArticle
} from '@/api/AppliConver'
export default {
  name: 'AppliFormIndex',
  components: {},
  props: {},
  ...
  methods: {
    ...
    init () {
      // 获取申请书列表
      this.getApplicationSheets()
      // 获取专业列表
      this.getMajors()
    },
    // 获取申请书列表
    async getApplicationSheets () {
      try {
        this.loading = true
        const res = await getApplicationSheets(this.queryForm)
        console.log(res)
